...
Shader "Piyong/Additive2_3000"
{
	Properties
	{
		...
		_InitUOffset ("U", Float) = 0.0		
		_InitVOffset ("V", Float) = 0.0		
		_InitRotate ("Rotate", Float) = 0.0
		_InitScale ("Scale", Float) = 1.0		
		_USpeed ("U Speed", Float) = 0.0
		_VSpeed ("V Speed", Float) = 0.0
		_RotateSpeed ("Rotate Speed", Float) = 0.0
		_ScaleSpeed ("Scale Speed", Float) = 0.0
		_InitUOffset2 ("U Offset2", Float) = 0.0		
		_InitVOffset2 ("V Offset2", Float) = 0.0		
		_InitRotate2 ("Rotate2", Float) = 0.0
		_InitScale2 ("Scale2", Float) = 1.0		
