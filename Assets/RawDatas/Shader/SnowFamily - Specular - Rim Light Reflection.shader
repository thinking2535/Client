...
Shader "Snow Family/Specular/Rim Light - Reflection"
{
        Properties {
        ...
        CGPROGRAM
          #pragma surface surf WrapLambert approxview exclude_path:prepass exclude_path:deferred noforwardadd	// alpha:fade
		  //#pragma debug
