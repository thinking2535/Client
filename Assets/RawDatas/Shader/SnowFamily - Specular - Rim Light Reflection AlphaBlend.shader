Shader "Snow Family/Specular/Rim Light - Reflection AlphaBlend"
{
        Properties {
	...
	//ZWrite On
        ...
        CGPROGRAM
          #pragma surface surf WrapLambert   approxview exclude_path:prepass exclude_path:deferred noforwardadd alphatest:_Cutoff//alpha:fade
          #pragma target 2.0
